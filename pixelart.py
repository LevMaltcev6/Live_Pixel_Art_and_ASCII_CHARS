...
class ArtConverter:
    def __init__(self, path='video/hh.mp4', pixel_size=7, color_lvl=8):
        pg.init()
        self.path = path
        ...
        self.recorder = cv2.VideoWriter('output/pixel_artw.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
